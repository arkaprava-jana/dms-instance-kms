...
Scenarios:
  ...
  Scenario: 2
    Given: At least one AWS DMS Replication Instance exists
      ...
      Then: Return NON_COMPLIANT with annotation "This AWS DMS Replication Instance is using AWS Managed Key for Encryption"
  Scenario: 3
    Given: At least one AWS DMS Replication Instance exists
...
def evaluate_compliance(event, configuration_item, valid_rule_parameters):
    ...
    for dms_instance_details in dms_instances:
        kmsid = dms_instance_details['KmsKeyId']
